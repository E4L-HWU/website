...
import { robowars1, robowars2, robowars3, robowars4, robowars5 } from "../../assets";
const images = [robowars1, robowars2, robowars3, robowars4, robowars5];
...
export default SectionWrapper(RoboWars, "RoboWars");