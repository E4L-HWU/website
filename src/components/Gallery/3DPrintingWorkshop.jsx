...
import { print1, print2, print3 } from "../../assets";
const images = [print1, print2, print3];

import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";

const PrintingWorkshop = () => {
    const settings = {
        infinite: true,
        speed: 500,
        slidesToShow: 3,
...
export default SectionWrapper(PrintingWorkshop, "3d-workshop");